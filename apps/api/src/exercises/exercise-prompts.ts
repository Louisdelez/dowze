...
const CONSIGNES: Record<string, string> = {
  flashcard:
    'Génère des flashcards (recto = question/terme, verso = réponse concise), une idée par carte.',
  qcm: 'Génère des QCM à EXACTEMENT 3 options (1 correcte + 2 distracteurs plausibles), avec un feedback.',
  short:
    'Génère des questions à réponse courte (un point unique), avec les réponses acceptées (+ synonymes).',
  cloze:
    'Génère des textes à trous : marque chaque trou par « ___ », et donne les réponses acceptées par trou.',
};
