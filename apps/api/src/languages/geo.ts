...
const BY_COUNTRY: Record<string, Proposal[]> = {
  CH: [
    {
      lang: 'de',
      pitch:
        "Parle avec 63 % de la Suisse dans sa langue — et jusqu'à +20 % de salaire selon les études (Grin).",
    },
    {
      lang: 'en',
      pitch: "La langue passe-partout du travail et du web : elle t'ouvre le monde entier.",
    },
    {
      lang: 'it',
      pitch:
        'Une langue nationale suisse : voyage et travaille des deux côtés de la frontière comme chez toi.',
    },
  ],
  BE: [
    {
      lang: 'nl',
      pitch: "Deviens vraiment bilingue de ton pays : la Flandre et Bruxelles s'ouvrent à toi.",
    },
    { lang: 'en', pitch: 'La langue passe-partout du travail international et du web.' },
    {
      lang: 'de',
      pitch: "Troisième langue officielle de Belgique et langue du voisin le plus fort d'Europe.",
    },
  ],
  FR: [
    {
      lang: 'en',
      pitch: 'La langue passe-partout du travail et du web : le meilleur premier investissement.',
    },
    {
      lang: 'es',
      pitch:
        'Deuxième langue la plus parlée au monde par ses natifs — voyage et travail à ta portée.',
    },
    {
      lang: 'de',
      pitch:
        "La langue du premier partenaire économique de la France, juste de l'autre côté du Rhin.",
    },
    {
      lang: 'it',
      pitch: 'La langue du voisin du sud : culture, cuisine et travail transfrontalier.',
    },
  ],
  DE: [
    ...
    {
      lang: 'es',
      pitch: "Une langue mondiale pour voyager et travailler bien au-delà de l'Europe.",
    },
  ],
  AT: [
    { lang: 'en', pitch: 'La langue passe-partout du travail et du web.' },
    {
      lang: 'it',
      pitch: 'La langue du voisin du sud, pour voyager et travailler des deux côtés des Alpes.',
    },
  ...
  IT: [
    ...
    {
      lang: 'fr',
      pitch: "La langue du voisin de l'ouest, proche de l'italien : tu progresseras vite.",
    },
  ],
  ES: [
    { lang: 'en', pitch: 'La langue passe-partout du travail et du web.' },
    { lang: 'fr', pitch: "La langue du voisin du nord, proche de l'espagnol : montée rapide." },
    {
      lang: 'pt',
      pitch:
        "Très proche de l'espagnol — tu ouvres tout le Brésil et le Portugal presque gratuitement.",
    },
  ],
  LU: [
    {
      lang: 'de',
      pitch: "L'une des langues du pays et du grand voisin : un socle pour le travail.",
    },
...
const FALLBACK: Proposal[] = [
  {
    lang: 'en',
    pitch: 'La langue passe-partout du travail et du web : le meilleur premier choix.',
  },
  {
    lang: 'es',
    pitch: "L'une des langues les plus parlées au monde — voyage et travail à grande échelle.",
  },
...
export function proposeLanguages(
  ...
  return merged
    .slice(0, max)
    .map((p) => ({ lang: p.lang, name: LANG_NAMES[p.lang] ?? p.lang, pitch: p.pitch }));
}
