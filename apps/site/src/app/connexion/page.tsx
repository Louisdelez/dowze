  ...
  return (
    <AuthShell title="Se connecter">
      <div className="space-y-4">
        ...
        <SubmitButton onClick={connecter} disabled={busy || !email || !password}>{busy ? 'Connexion…' : 'Se connecter'}</SubmitButton>
        ...
        <p className="text-center text-xs font-bold uppercase italic tracking-tight text-black/60">
          Pas de compte ? <a href="/inscription" className="text-dowze-red hover:underline">S’inscrire</a>
        </p>
      </div>
    </AuthShell>
  );
